...
for key, combat in pairs(combat_types) do
	...
	setCombatFormula(combat.object, COMBAT_FORMULA_LEVELMAGIC, 0, -130000, 0, -135000)
	...
	setCombatFormula(combat.object2, COMBAT_FORMULA_LEVELMAGIC, 0, -185000, 0, -186000)
	...
	setCombatFormula(combat.object3, COMBAT_FORMULA_LEVELMAGIC, 0, -215000, 0, -216000)
	...
	setCombatFormula(combat.object4, COMBAT_FORMULA_LEVELMAGIC, 0, -280000, 0, -285000)
