...
for _, v in pairs(w) do
	...
	setCombatFormula(combat, COMBAT_FORMULA_SKILL, 2.7, 0, 2.7, 0)
...
for _, v in pairs(w) do
	...
	setCombatFormula(combat2, COMBAT_FORMULA_SKILL, 3.6, 0, 3.6, 0)
...
for _, v in pairs(w) do
	...
	setCombatFormula(combat3, COMBAT_FORMULA_SKILL, 4.6, 0, 4.6, 0)
...
for _, v in pairs(w) do
	...
	setCombatFormula(combat4, COMBAT_FORMULA_SKILL, 5.2, 0, 5.2, 0)
