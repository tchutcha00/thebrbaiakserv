...
local config = {
	...
	msg = {
		help = "Use o comando exemplo: !soul holy Efeitos disponíveis: ice, fire, earth, energy, holy, death, e none para desabilitar. A troca para outro elemento custa 1kk.",
