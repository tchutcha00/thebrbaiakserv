-- CONFIGURAÇÕES
	...
	quantheal = 20 -- porcentagem do hp máximo que cada cura irá curar. (No caso, irá curar 5% do hp máximo cada cura)
	...
	tipoaura = 40 -- número do efeito da aura (efeito de distância, pode ser identificado com /x no jogo)
