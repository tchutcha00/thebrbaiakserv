...
if(NpcHandler == nil) then
	...
	-- coinId
	MESSAGE_BUY_COINID = 24
	MESSAGE_ONBUY_COINID = 25
	MESSAGE_SELL_COINID = 26
	MESSAGE_ONSELL_COINID = 27
	MESSAGE_NEEDCOINID = 28
	...
	NpcHandler = {
		...
		messages = {
			...
			-- coinId
			[MESSAGE_BUY_COINID] = "Do you want to buy |ITEMCOUNT| |ITEMNAME| for |TOTALCOST| |COINIDNAME|?",
			[MESSAGE_ONBUY_COINID] = "Bought |ITEMCOUNT|x |ITEMNAME| for |TOTALCOST| |COINIDNAME|.",
			[MESSAGE_SELL_COINID] = "Do you want to sell |ITEMCOUNT| |ITEMNAME| for |TOTALCOST| |COINIDNAME|?",
			[MESSAGE_ONSELL_COINID] = "Sold |ITEMCOUNT|x |ITEMNAME| for |TOTALCOST| |COINIDNAME|.",
			[MESSAGE_NEEDCOINID] = "You don't have enough |COINIDNAME|.",
		}
	}
