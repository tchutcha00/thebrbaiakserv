      ...
      if sto_ativ == 1 or sto_ativ == -1 then
         ...
         guild_sto = getGlobalStorageValue(storages[3])
            ...
            if guild ~= guild_sto then            
               ...
               doBroadcastMessage("[Castle24Hrs] O(a) "..getCreatureName(cid).." acabou de conquistar o castelo "..castle_one_name.." para a guild \""..guildname.."\" pela "..sto_vezes_total.."ª vez(s). Premio: 20% a mais de exp.", 22)
